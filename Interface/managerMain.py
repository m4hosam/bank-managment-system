...
class Ui_MainWindow(object):
    ...
    def interface(self):
        # print(self.updateCurrency.isChecked())
        ...
        if self.main.isChecked():
            ...
            self.income.setText(_translate("MainWindow", ""))
            self.expenses.setText(_translate("MainWindow", ""))
            self.profit.setText(_translate("MainWindow", ""))
            self.balance.setText(_translate("MainWindow", ""))
