...
query1 = '''SELECT ua1.cus_id src_cus, ua2.cus_id rsv_cus, tr.* , (a1.balance - total) src_balance, (a2.balance + total *(c1.exch_rate /c2.exch_rate)) rsv_balance 
